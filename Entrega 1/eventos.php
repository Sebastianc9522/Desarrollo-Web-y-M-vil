...
<head>
    ...
    <title>Craft & Beer - Eventos</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <nav class="container-fluid mb-4">
        <div class="d-flex justify-content-center gap-4">
            ...
            <button class="btn nav-btn btn-activo px-5 py-2 shadow-sm" disabled>Eventos</button>
    ...
    <main class="container-fluid mb-5 mt-4 px-4">
        <div class="text-center mb-5">
            <h2 class="fw-bold text-dark display-6">Próximos Eventos</h2>
        </div>

        <div class="row g-4">
            <!-- Evento 1 -->
            <div class="col-md-4">
                <div class="event-card tarjeta-prod1 shadow-sm text-center">
                    <i class="fa fa-calendar-check-o fa-4x mb-3 text-dark"></i>
                    <div>
                        <h4 class="fw-bold mb-1">Cata Guiada de IPAs</h4>
                        <p class="fw-bold text-danger mb-3">Viernes, 25 de Septiembre</p>
                        <p class="small">Aprende a distinguir los perfiles aromáticos de nuestras mejores IPAs. Incluye maridaje con tabla de quesos.</p>
                    </div>
                    <button class="btn btn-dark w-100 shadow-sm fw-bold">Más información</button>
                </div>
            </div>
            
            <!-- Evento 2 -->
            <div class="col-md-4">
                <div class="event-card tarjeta-prod3 shadow-sm text-center">
                    <i class="fa fa-music fa-4x mb-3 text-warning"></i>
                    <div>
                        <h4 class="fw-bold mb-1">Música en Vivo & Stouts</h4>
                        <p class="fw-bold text-warning mb-3">Sábado, 03 de Octubre</p>
                        <p class="small text-white-50">Disfruta de una noche de blues y jazz en vivo mientras degustas nuestra Imperial Stout exclusiva de temporada.</p>
                    </div>
                    <button class="btn btn-warning w-100 shadow-sm fw-bold border-dark">Más información</button>
                </div>
            </div>
            
            <!-- Evento 3 -->
            <div class="col-md-4">
                <div class="event-card tarjeta-prod2 shadow-sm text-center">
                    <i class="fa fa-beer fa-4x mb-3 text-dark"></i>
                    <div>
                        <h4 class="fw-bold mb-1">Taller: Haz tu Pale Ale</h4>
                        <p class="fw-bold text-danger mb-3">Domingo, 11 de Octubre</p>
                        <p class="small">Un taller interactivo de 4 horas donde nuestros maestros cerveceros te enseñarán el proceso de cocción desde cero.</p>
                    </div>
                    <button class="btn btn-dark w-100 shadow-sm fw-bold">Más información</button>
                </div>
            </div>
